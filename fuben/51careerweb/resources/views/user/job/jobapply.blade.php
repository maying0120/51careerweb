...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/magnific-popup.css') }}"

    <!-- jQuery 1.7.2+ or Zepto.js 1.0+ -->
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>

    <!-- Magnific Popup core js file -->
    <script src="{{ asset('user/job/apply/js/jquery.magnific-popup.min.js') }}"></script>

    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet">
    <!--
    CSS
    ============================================= -->
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/linearicons.css') }}"
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/nice-select.css') }}">
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('user/job/apply/css/main.css') }}">
</head>
...
<script src="{{ asset('user/job/apply/js/vendor/jquery-2.2.4.min.js') }}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
<script src="{{ asset('user/job/apply/js/vendor/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
<script src="{{ asset('user/job/apply/js/easing.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/hoverIntent.js') }}"></script>
<script src="{{ asset('user/job/apply/js/superfish.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/jquery.ajaxchimp.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/jquery.sticky.js') }}"></script>
<script src="{{ asset('user/job/apply/js/jquery.nice-select.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/parallax.min.js') }}"></script>
<script src="{{ asset('user/job/apply/js/mail-script.js') }}"></script>
<script src="{{ asset('user/job/apply/js/main.js') }}"></script>