...
<script>
  ...
  <main id="main">
          ...
          <img src="{{ asset('user/img/background/joinusbg.jpg') }}" style=" margin-top:-80px; width:100%;" />
           ...
           {{-- <hr  style="color: #ccddff">--}}
              ...
              <div class="form-row">
                ...
                <div class="col-md-3 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="First Name" data-rule="minlen:2" data-msg="Please enter at least 2 chars" />
                  <div class="validate"></div>
                </div>

                    <div class="col-md-3 form-group">
                                  <input type="text" name="name" class="form-control" id="name" placeholder="Last Name" data-rule="minlen:2" data-msg="Please enter at least 2 chars" />
                                  <div class="validate"></div>
                                </div>
                ...
                <div class="col-md-6 form-group">
                 ...
                 <div class="col-md-3 form-group">
                                  <input type="phone" name="phone" class="form-control" id="phone" placeholder="Your phone" data-rule="phone" data-msg="Please enter a valid phone number" />
                                  <div class="validate"></div>
                                </div>
