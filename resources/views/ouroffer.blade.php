...
<div class="container" >
  ...
  {{--  <div id="about" class="about-area area-padding" style=" margin-top:-70px;z-index:-1;height:790px;background-image: url('user/img/slider/offerbgupdated.jpeg') ; background-size:100% 790px;">
    ...
    --}}
    <!-- ======= Portfolio Section ======= -->
    <section class="portfolio"  style="background-color:#01497c;">
      <div class="container"style="background-color:#01497c;">
  ...
  <div class="col-lg-12 col-md-12" style="background-color:white;">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500" style="margin-top:-20px; " >
          ...
          <div class="col-lg-5 col-md-5 filter-app" style="padding-left:30px;">
          ...
          <div class="col-lg-7 col-md-7 filter-app ">   <div style="background-color:white ;height:100%;">

            <img src="{{ asset('user/story/assets/img/offer/kpmg.png') }}" style="padding-left:26%; margin-top:60px;" alt="" >

            <div class="text-left"style="margin-top:10px; color:white; margin-left:20px;margin-right:20px;">

              <h4 > <strong>Member Background:</strong> University of Bufflao, Ms in Accountancy, Excellent English Communication Skills, Various extracurricular actives  </h4>
              <h4 > <strong>Weakness:</strong> 1. Unclear Career Path
        <br>2.  Insufficient interview storytelling skills
              <br> 3. Short of specific industry insight and knowledge communication Skills</h4>

              <h4 ><strong> Result: </strong>KPMG - Tax Analyst Full time </h4>
              <h4> Through our professional profile assessment and Gauranteed Internship Offer program, the client realized
                her passion in the tax filed and would like to become a tax professional. After our comprephensive coaching services
                and resourceful referral services, she finally got her dream job.</h4>
        ...
        <div class="col-lg-12 col-md-12" style="background-color:white; margin-top:40px;">
