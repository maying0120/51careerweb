...
<html><head>
    ...
    <title>我的简历-</title>
    <link rel="stylesheet"  href="{{ asset('user/info/style/css/style.css') }}" >
    <link  rel="stylesheet" href="{{ asset('user/info/style/css/external.min.css') }}" >
    <link  rel="stylesheet" href="{{ asset('user/info/style/css/popup.css') }}" >
...
<div id="body">
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
                        ...
                        <div class="m_portrait">
                            <div></div>
                            <img width="120" height="120" alt="jason" src="{{ asset('user/info/style/images/default_headpic.png') }}">
                        </div>
                    </div>
    ...
    <script async="" src="{{ asset('user/info/style/js/conversion.js') }}"></script>

    <script src="{{ asset('user/info/style/js/jquery.1.10.1.min.js') }}"></script>
    <script src="{{ asset('user/info/style/js/jquery.lib.min.js') }}" ></script>

    <script  src="{{ asset('user/info/style/js/ajaxfileupload.js') }}"></script>
    <script src="{{ asset('user/info/style/js/additional-methods.js') }}" ></script>
    <script src="{{ asset('user/info/style/js/excanvas.js') }}"></script>
    <script src="{{ asset('user/info/style/js/conv.js') }}"></script>
    <script src="{{ asset('user/info/style/js/ajaxCross.json') }}"></script>
    <script src="{{ asset('user/info/style/js/Chart.min.js') }}"></script>
    <script src="{{ asset('user/info/style/js/profile.min.js') }}"></script>
    <script src="{{ asset('user/info/style/js/core.min.js') }}"></script>
    <script src="{{ asset('user/info/style/js/popup.min.js') }}"></script>
