<!DOCTYPE HTML>
<html><head>
  <script type="text/javascript" async="" src="{{ asset('user/info/style/js/conversion.js') }}"></script><script src="{{ asset('user/info/style/js/allmobilize.min.js') }}" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>


    <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
    <title>我的简历-</title>

    <link href="{{ asset('user/info/style/css/style.css') }}" type="text/css" rel="stylesheet">
    <link href="{{ asset('user/info/style/css/external.min.css') }}"s type="text/css" rel="stylesheet">
    <link href="{{ asset('user/info/style/css/popup.css') }}" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="{{ asset('user/info/style/js/jquery.1.10.1.min.js') }}"></script>
    <script src="{{ asset('user/info/style/js/jquery.lib.min.js') }}" type="text/javascript"></script>
    <script type="text/javascript" src="{{ asset('user/info/style/js/ajaxfileupload.js') }}"></script>
    <script src="{{ asset('user/info/style/js/additional-methods.js') }}" type="text/javascript"></script>

    <script type="text/javascript" src="{{ asset('user/info/style/js/excanvas.js') }}"></script>


    <script src="{{ asset('user/info/style/js/conv.js') }}"type="text/javascript"></script>
    <script src="{{ asset('user/info/style/js/ajaxCross.json') }}" charset="UTF-8"></script></head>
<body>
<div id="body">
    <div id="container">
        ...
        <div class="clearfix">
            <div class="content_l">
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <input type="hidden" id="nameVal" value="Ying Ma">
            ...
            <script src="{{ asset('user/info/style/js/Chart.min.js') }}" type="text/javascript"></script>
            <script src="{{ asset('user/info/style/js/profile.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('user/info/style/js/core.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('user/info/style/js/popup.min.js') }}" type="text/javascript"></script>
