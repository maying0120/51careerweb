  ...
  <script src="{{ asset('user/vendor/appear/jquery.appear.js') }}"></script>
  <script src="{{ asset('user/vendor/knob/jquery.knob.js') }}"></script>
  <script src="{{ asset('user/vendor/parallax/parallax.js') }}"></script>
  <script src="{{ asset('user/vendor/wow/wow.min.js') }}"></script>
  <script src="{{ asset('user/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('user/vendor/nivo-slider/js/jquery.nivo.slider.js') }}"></script>
